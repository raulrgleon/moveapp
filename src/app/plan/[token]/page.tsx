  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <p className="text-muted-foreground">This plan link is not available.</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-muted/30 py-8 px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        <header className="text-center space-y-2">
          <p className="text-sm text-muted-foreground">MovePilotAi — shared plan</p>
          <h1 className="text-2xl font-bold">{data.ownerName}&apos;s move</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border bg-card p-4 text-center">
            ...
            <p className="font-semibold">{formatDate(data.moveDate, "en")}</p>
          </div>
          <div className="rounded-xl border bg-card p-4 text-center">
        ...
        {data.truckChoice && (
          <div className="rounded-xl border bg-card p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Truck / trailer choice</p>
        ...
        <div className="rounded-xl border bg-card overflow-hidden">
          <div className="p-4 border-b font-medium">Budget breakdown</div>
        ...
        <p className="text-xs text-center text-muted-foreground">
          Read-only view · Estimates only — confirm prices with providers before booking.
        </p>
      </div>
    </div>
  );
